...
////    public void consume( Object enrichedDto) {
////        System.out.println("Transaction enrichie reçue de Kafka : " + enrichedDto);
////
////        // Appel du service d'enrichissement
////      //  Object enrichedTransaction = transactionEnrichedClient.enrichTransaction(enrichedDto.getTransactionId());
////
////        System.out.println("Transaction après enrichissement : " );
////    }
//    }
//
